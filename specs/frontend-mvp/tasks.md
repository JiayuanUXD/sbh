...
- [F0：工程与质量基线](./tasks/F0-baseline.md)
- [F1：公开数据契约与统一有效供给](./tasks/F1-public-catalog.md)
- [F2：全局视觉系统与页面外壳](./tasks/F2-design-system.md)
- [F3：首页与房源列表](./tasks/F3-home-list.md)
- [F4：房源详情与楼盘详情](./tasks/F4-details.md)
- [F5：咨询表单与 CRM 闭环](./tasks/F5-inquiry.md)
- [F6：内容页、SEO 与缓存](./tasks/F6-content-seo.md)
- [F7：综合质量与上线准备](./tasks/F7-acceptance.md)
