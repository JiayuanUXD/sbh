...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TYPE "public"."enum_listings_data_source_source" ADD VALUE 'manual-import';
  CREATE TABLE "supply_import_batches" (
  ...
  ALTER TABLE "buildings" ADD COLUMN "data_source_source" "enum_buildings_data_source_source";
  ALTER TABLE "buildings" ADD COLUMN "data_source_external_id" varchar;
  ALTER TABLE "buildings" ADD COLUMN "data_source_synced_at" timestamp(3) with time zone;
  ALTER TABLE "buildings" ADD COLUMN "data_source_source_url" varchar;
  ALTER TABLE "payload_locked_documents_rels" ADD COLUMN "supply_import_batches_id" integer;
  ALTER TABLE "payload_locked_documents_rels" ADD COLUMN "location_aliases_id" integer;
  ...
  CREATE INDEX "supply_import_batches_operator_idx" ON "supply_import_batches" USING btree ("operator_id");
  CREATE INDEX "supply_import_batches_city_idx" ON "supply_import_batches" USING btree ("city_id");
  CREATE INDEX "supply_import_batches_updated_at_idx" ON "supply_import_batches" USING btree ("updated_at");
  CREATE INDEX "supply_import_batches_created_at_idx" ON "supply_import_batches" USING btree ("created_at");
  CREATE INDEX "location_aliases_normalized_alias_idx" ON "location_aliases" USING btree ("normalized_alias");
  CREATE INDEX "location_aliases_location_idx" ON "location_aliases" USING btree ("location_id");
  CREATE INDEX "location_aliases_updated_at_idx" ON "location_aliases" USING btree ("updated_at");
  CREATE INDEX "location_aliases_created_at_idx" ON "location_aliases" USING btree ("created_at");
  CREATE UNIQUE INDEX "normalizedAlias_kind_idx" ON "location_aliases" USING btree ("normalized_alias","kind");
  ...
  CREATE INDEX "payload_locked_documents_rels_supply_import_batches_id_idx" ON "payload_locked_documents_rels" USING btree ("supply_import_batches_id");
  CREATE INDEX "payload_locked_documents_rels_location_aliases_id_idx" ON "payload_locked_documents_rels" USING btree ("location_aliases_id");`)
}
