...
/**
 * 楼盘详情 V2 布局：对标 58 商办详情结构。
 * 首屏画廊+决策面板，房源区主列+粘性右栏，参数/特色合并，位置灰底成带。
 * 评审通过后替换 BuildingDetailLayout（V1）。
 */
type BuildingDetailLayoutV2Props = Readonly<{
...
export default function BuildingDetailLayoutV2({
  building,
  supply,
  relatedBuildings,
  serviceSchedule,
  ...
  const anchors = [
    { id: 'params', label: '楼盘参数', visible: hasParams },
    { id: 'supply', label: '在租房源', visible: true },
    { id: 'location', label: '位置交通', visible: true },
    { id: 'related', label: '猜你喜欢', visible: hasRelated },
  ]
