    ...
    <div className="page-detail">
      ...
      <article className="page-detail__body">
        ...
        <p>
          ...
          <strong>在您提交咨询之前，它无法用于跨天或跨设备识别您本人</strong>。
        </p>
        <p>
          <strong>提交咨询之后</strong>：为便于顾问了解您的关注点，我们会把您<strong>本次访问</strong>
          的上述匿名浏览记录与该条咨询关联起来。关联使用的是一个由服务器密钥单向生成的
          <strong>假名标识</strong>——它不含您的手机号、姓名或任何可读信息，
          外部无法据此反推出您的身份，我们也不会用它去关联您在提交之前的历史访问或其他设备。
          未提交咨询时，浏览记录始终保持匿名、不与任何人关联。
        </p>

        <h2>二、信息的使用目的</h2>
        <ul>
          <li>安排专属顾问就您的选址或房源投放需求与您电话联系；</li>
          <li>在后台为线索标注来源页面，以及您本次访问浏览过的房源，以便顾问了解您的意图、提供更准确的方案；</li>
