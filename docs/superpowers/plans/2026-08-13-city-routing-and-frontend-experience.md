...
- [ ] **Step 1: Write failing switcher rendering and keyboard tests**
...
- [ ] **Step 3: Fetch cached public city options in the server layout**
...
- [ ] **Step 4: Implement accessible desktop popover and mobile drawer**
