...
- [x] **Step 1: Write failing domain/access/permission tests**
...
- [x] **Step 3: Implement closed domain types and transition rules**
...
- [x] **Step 4: Implement Collection field groups and access**
...
- [x] **Step 5: Register permissions, roles, navigation, and badge**
...
- [x] **Step 6: Generate schema migration and add permission migration**
...
- [x] **Step 7: Dry-run/apply locally and verify database invariants**
...
- [x] **Step 8: Run tests and commit Task 1**
